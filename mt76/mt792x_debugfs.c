...
static void
mt7902_mt792x_ampdu_stat_read_phy(struct mt7902_mt792x_phy *phy,
...
int mt7902_mt792x_tx_stats_show(struct seq_file *file, void *data)
{
	...
	mt7902_mt792x_ampdu_stat_read_phy(phy, file);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_tx_stats_show);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_queues_acq);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_queues_read);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_pm_stats);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_pm_idle_timeout_set);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_pm_idle_timeout_get);
