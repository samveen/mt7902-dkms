...
static void
mt7902_mt76_connac3_mac_decode_he_radiotap_ru(struct mt7902_mt76_rx_status *status,
...
static void
mt7902_mt76_connac3_mac_decode_he_mu_radiotap(struct sk_buff *skb, __le32 *rxv)
{
					 ...
					 u8 mode)
{
	...
	case MT_PHY_TYPE_HE_MU:
		...
		mt7902_mt76_connac3_mac_decode_he_radiotap_ru(status, he, rxv);
		mt7902_mt76_connac3_mac_decode_he_mu_radiotap(skb, rxv);
		break;
...
EXPORT_SYMBOL_GPL(mt7902_mt76_connac3_mac_decode_he_radiotap);
