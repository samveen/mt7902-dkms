		 ...
		 int timeout)
{
	...
	timeout /= 10;
	do {
		cur = __mt7902_mt76_rr(dev, offset) & mask;
		if (cur == val)
			return true;
...
EXPORT_SYMBOL_GPL(__mt7902_mt76_poll);
...
EXPORT_SYMBOL_GPL(____mt7902_mt76_poll_msec);
...
EXPORT_SYMBOL_GPL(mt7902_mt76_wcid_alloc);
...
EXPORT_SYMBOL_GPL(mt7902_mt76_get_min_avg_rssi);

int __mt7902_mt76_worker_fn(void *ptr)
{
	struct mt7902_mt76_worker *w = ptr;
...
EXPORT_SYMBOL_GPL(__mt7902_mt76_worker_fn);
